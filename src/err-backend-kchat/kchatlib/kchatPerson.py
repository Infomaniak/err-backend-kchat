...
log = logging.getLogger("errbot.backends.kchat.person")


class KchatPerson(Person):
    """
    A Person in Kchat
    """
    ...
    def __eq__(self, other):
        if not isinstance(other, KchatPerson):
            log.warning("Tried to compare a KchatPerson with a %s", type(other))
            return False
